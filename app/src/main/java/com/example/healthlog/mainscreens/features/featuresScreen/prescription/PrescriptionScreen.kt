...
@Composable
fun PrescriptionScreen(navigationManager: NavigationManager) {
    var prescriptionTitleState = remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "image from a Certified Doctor",
                    fontSize = 18.sp,
                    fontWeight = FontWeight.Medium,
                    modifier = Modifier.padding(bottom = 8.dp),
                    color = Color.Black
                ...
                Text(
                    text = "Always upload a clear copy of your prescription",
                    fontSize = 14.sp,
...
//            }
                ...
                OutlinedTextField(
                    value = prescriptionTitleState.value,
                    onValueChange = { prescriptionTitleState.value = it },
                    modifier = Modifier
                        .padding(start = 0.dp)
                        .fillMaxWidth(0.9f)
                        .height(50.dp)
